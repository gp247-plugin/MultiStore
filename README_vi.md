...
- **Cấp quyền quản trị riêng cho từng cửa hàng (Pro):** giao mỗi cửa hàng cho một người quản trị riêng (có sẵn 2 vai trò mẫu *Store Admin* / *Store Member*); họ đăng nhập trên domain cửa hàng, chỉ thấy phạm vi được giao và không vào admin gốc — **mọi thao tác cấp hệ thống luôn bị chặn dù được cấp quyền gì**.
